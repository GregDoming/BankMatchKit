...
import ToolsNavigationTabs from "components/NavigationTabs/ToolsNavigationTabs.js";
    ...
    <>
      ...
      <GridContainer justify="center">
          <GridItem xs={12} sm={12} md={8} className={classes.textCenter}>
            <h2 className={classes.title}>Welcome to the Tools Portal, {props.auth.user.username}</h2>
          </GridItem>
        </GridContainer>
