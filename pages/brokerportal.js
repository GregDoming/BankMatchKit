...
import BrokerNavigationTabs from "components/NavigationTabs/BrokerNavigationTabs.js";
  ...
  return (
    <>
      ...
      <div className={classes.main}>
        <BrokerNavigationTabs />
      <GridContainer justify="center">
          <GridItem xs={12} sm={12} md={8} className={classes.textCenter}>
            <h2 className={classes.title}>Welcome to the Broker Portal, {props.auth.user.username}</h2>
          </GridItem>
        </GridContainer>
