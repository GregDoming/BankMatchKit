export const convertUser = flatUserObj => {
  ...
  const userSchema = {
    userProfile: {
      ...
      typeOfLender: "Bank",
      specialtySelectOne: "none",
      specialtySelectTwo: "none",
      specialtySelectThree: "none",
      specialtySelectFour: "none",
      specialtySelectFive: "none",
      specialtySelectSix: "none",
      specialtySelectSeven: "none",
      specialtySelectEight: "none",
      specialtySelectNine: "none",
      specialtySelectZero: "none",
    },
    ownerOccupied: {
      purchase: "UNKNOWN",
      refinance: "UNKNOWN",
    ...
    miscellaneous: {
      ...
      miscellaneousSingleFamilyResidential: "UNKNOWN",
      miscellaneousTwoFourUnit: "UNKNOWN",
      miscellaneousSpecialUse: "UNKNOWN",
      miscellaneousUrbanInfill: "UNKNOWN",
      miscellaneousForeignPropertyNonUSProperty: "UNKNOWN"
    },
    financialCreditIssue: {
      financialCreditIssueStatedIncome: "UNKNOWN",
      financialCreditIssueGiftFunds: "UNKNOWN",
    ...
    miscellaneousQualifiers: {
      miscellaneousQualifiersAssestBasedLendingInv: "UNKNOWN",
      ...
      miscellaneousQualifiersSubordinateFinancingAllowed: "UNKNOWN",
      miscellaneousQualifiersSubordinateFinancing: "UNKNOWN",
      miscellaneousQualifiersDeferredMaintenance: "UNKNOWN"
    }
  };
